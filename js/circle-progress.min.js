    ...
    (t.prototype = {
        ...
        drawEmptyArc: function (i) {
            var t = this.ctx,
                ...
                b = 1.6;
            n = this.startAngle;
            i < 1 && (t.save(), t.beginPath(), i <= 0 ? t.arc(e, e, e - a / 2, 0, 2 * Math.PI) : this.reverse ? t.arc(e, e, e - a / 2, n, n - 2 * Math.PI * i) : t.arc(e, e, e - a / 2, n + 2 * Math.PI * i, n), (t.lineWidth = b), (t.strokeStyle = this.emptyFill), t.stroke(), t.restore());
        },
